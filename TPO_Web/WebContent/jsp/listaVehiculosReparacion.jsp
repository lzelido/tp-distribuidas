...
<body>
	...
	<div class="col-md-9 col-lg-9 col-md-offset-3 col-lg-offset-3">
		<form role="form" id="formulario" method="post" action="MandarAlTaller">
			<fieldset class="col-md-8 col-lg-8">		        	     	
		         	<c:forEach var="ve" items="${vehiculos}">
		         		...
		         		<div class="col-md-4 col-lg-4">
		         			<c:if test="${ve.     garantiaHasta}">
			         			<button type="submit" class="btn btn-success btn-lg">
									Taller Oficial
								</button>
							</c:if>
							
							<c:if test="${ve.     kilometraje}">
								<button class="btn btn-danger" onClick="mandarAlTaller(this);">
										Agencia Oficial
								</button>
							</c:if>
	...
	<script>
		function mandarAlTaller(elemento){
			var matricula = $(elemento).parent("div").find("input").val();
