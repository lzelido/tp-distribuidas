...
public class GenerarPedido extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getParameter("domicilioEntrega") != null && request.getParameter("domicilioEntrega") != "") {
			...
			domicilioEntrega.setNumero(domicilioEntregaDatos.get("numero") == null ? 0
					: Integer.parseInt(domicilioEntregaDatos.get("numero")));
			domicilioEntrega.setPiso(domicilioEntregaDatos.get("piso") == null ? 0
					: Integer.parseInt(domicilioEntregaDatos.get("piso")));
			...
			GPSdomicilioEntrega.setGradosLat(domicilioEntregaDatos.get("gradosLat") == null ? 0
					: Integer.parseInt(domicilioEntregaDatos.get("gradosLat")));
			GPSdomicilioEntrega.setMinutosLat(domicilioEntregaDatos.get("minutosLat") == null ? 0
					: Integer.parseInt(domicilioEntregaDatos.get("minutosLat")));
			GPSdomicilioEntrega.setSegundosLat(domicilioEntregaDatos.get("segundosLat") == null ? 0
					: Integer.parseInt(domicilioEntregaDatos.get("segundosLat")));
			GPSdomicilioEntrega.setLongitud(domicilioEntregaDatos.get("longitud"));
			GPSdomicilioEntrega.setGradosLon(domicilioEntregaDatos.get("gradosLon") == null ? 0
					: Integer.parseInt(domicilioEntregaDatos.get("gradosLon")));
			GPSdomicilioEntrega.setMinutosLon(domicilioEntregaDatos.get("minutosLon") == null ? 0
					: Integer.parseInt(domicilioEntregaDatos.get("minutosLon")));
			GPSdomicilioEntrega.setSegundosLon(domicilioEntregaDatos.get("segundosLon") == null ? 0
					: Integer.parseInt(domicilioEntregaDatos.get("segundosLon")));
			domicilioEntrega.setGps(GPSdomicilioEntrega);

			solicitud.setDomicilioEntrega(domicilioEntrega);
		}

		solicitud.setEsRetiroDomicilio(request.getParameter("esRetiroDomicilio") == null
				|| !"on".equals(request.getParameter("esRetiroDomicilio")) ? false : true);
		if (request.getParameter("domicilioRetiro") != null && request.getParameter("domicilioRetiro") != "") {
			...
			domicilioRetiro.setNumero(domicilioRetiroDatos.get("numero") == null ? 0
					: Integer.parseInt(domicilioRetiroDatos.get("numero")));
			domicilioRetiro.setPiso(
					domicilioRetiroDatos.get("piso") == null ? 0 : Integer.parseInt(domicilioRetiroDatos.get("piso")));
			...
			GPSdomicilioRetiro.setGradosLat(domicilioRetiroDatos.get("gradosLat") == null ? 0
					: Integer.parseInt(domicilioRetiroDatos.get("gradosLat")));
			GPSdomicilioRetiro.setMinutosLat(domicilioRetiroDatos.get("minutosLat") == null ? 0
					: Integer.parseInt(domicilioRetiroDatos.get("minutosLat")));
			GPSdomicilioRetiro.setSegundosLat(domicilioRetiroDatos.get("segundosLat") == null ? 0
					: Integer.parseInt(domicilioRetiroDatos.get("segundosLat")));
			GPSdomicilioRetiro.setLongitud(domicilioRetiroDatos.get("longitud"));
			GPSdomicilioRetiro.setGradosLon(domicilioRetiroDatos.get("gradosLon") == null ? 0
					: Integer.parseInt(domicilioRetiroDatos.get("gradosLon")));
			GPSdomicilioRetiro.setMinutosLon(domicilioRetiroDatos.get("minutosLon") == null ? 0
					: Integer.parseInt(domicilioRetiroDatos.get("minutosLon")));
			GPSdomicilioRetiro.setSegundosLon(domicilioRetiroDatos.get("segundosLon") == null ? 0
					: Integer.parseInt(domicilioRetiroDatos.get("segundosLon")));
		...
		for (int i = 0; i < cargasString.length; i++) {
			...
			c.setCantApliable(
					datosCarga.get("cantApilable") == null ? 0 : Integer.parseInt(datosCarga.get("cantApilable")));
			...
			c.setEsApilable(
					datosCarga.get("apilable") == null || !"on".equals(datosCarga.get("apilable")) ? false : true);
			c.setEsRefrigerada(datosCarga.get("refrigerada") == null || !"on".equals(datosCarga.get("refrigerada"))
					? false : true);
			...
			dim.setUnidadX(UnidadMetrica.valueOf(datosCarga.get("unidadCoordx")));
			dim.setUnidadY(UnidadMetrica.valueOf(datosCarga.get("unidadCoordY")));
			dim.setUnidadZ(UnidadMetrica.valueOf(datosCarga.get("unidadCoordZ")));
