...
public class CargaDTO implements Serializable{
	...
	private TipoMercaderiaDTO tipoM;
	private float peso;
	private DimensionDTO dimensiones;
	private float volumen;
	private CategoriaFragilidadDTO fragilidad;
	...
	public TipoMercaderiaDTO getTipoM() {
		return tipoM;
	}

	public void setTipoM(TipoMercaderiaDTO tipoM) {
		this.tipoM = tipoM;
	}
	...
	public CategoriaFragilidadDTO getFragilidad() {
		return fragilidad;
	}

	public void setFragilidad(CategoriaFragilidadDTO fragilidad) {
