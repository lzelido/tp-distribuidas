...
public class ProveedorLocalAltaView extends javax.swing.JDialog {
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				ProveedorLocalAltaView inst = new ProveedorLocalAltaView(frame);
				inst.setVisible(true);
			}
		});
	}
	
	public ProveedorLocalAltaView(JFrame frame) {
		super(frame);
		initGUI();
	}
				...
				this.setTitle("Alta Unidad");
				{
					...
					altaProveedor.addActionListener(new ActionListener() {
					    public void actionPerformed(ActionEvent e) {
					        ...
					        try {
								ProveedorController.getInstance().altaProveedorLocal(proveedor);
