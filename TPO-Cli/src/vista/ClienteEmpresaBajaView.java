...
public class ClienteEmpresaBajaView extends javax.swing.JDialog {
	...
	private void initGUI() {
		try {
			...
			this.setTitle("Eliminación de Empresa");
...
//			new Principal();
			...
			System.out.println("Mensaje Error al cancelar la eliminación de una empresa: " + e.getMessage());
			System.out.println("Stack Trace al cancelar la eliminación de una empresa: " + e.getStackTrace());
			JOptionPane.showMessageDialog(this, e, "Error", JOptionPane.ERROR_MESSAGE);
		}
	}
}
