...
public class RutaAltaView extends javax.swing.JDialog {
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				...
				RutaAltaView inst = new RutaAltaView();
		...
		try{
			...
			if(response == JOptionPane.NO_OPTION){
				...
				if (response == JOptionPane.YES_OPTION){
					...
					if (check == 2){
						String mensaje = "Se dio de alta la nueva ruta";
						...
						if(check == 1){
							...
							String mensaje = "Falla en el alta de la nueva ruta";
							JOptionPane.showMessageDialog(this, mensaje, "ERROR", JOptionPane.ERROR_MESSAGE);
						}
					}
					
					RutaAltaView.this.dispose();
//					new Principal();
				}
			}
		}catch (Error e){
...
//			new Principal();
			...
			System.out.println("Mensaje Error al cancelar el alta de una ruta: " + e.getMessage());
			System.out.println("Stack Trace al cancelar el alta de una ruta: " + e.getStackTrace());
			JOptionPane.showMessageDialog(this, e, "Error", JOptionPane.ERROR_MESSAGE);
		}
	}
}
