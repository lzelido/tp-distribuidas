...
public class UbicacionAltaView extends javax.swing.JDialog {
	...
	public UbicacionAltaView(EmpresaDTO empresa, RemitoDTO remito, SucursalDTO sucursal, TallerDTO taller) {
		super();
		initGUI();
		this.loadData(empresa, remito, sucursal, taller);
	...
	private void initGUI() {
		try {
			...
			this.setTitle("Alta de Ubicación");
	...
	private void loadData (EmpresaDTO empresa, RemitoDTO remito, SucursalDTO sucursal, TallerDTO taller){
		try {
	...
	private void btnAceptar (ActionEvent evt){
		try {
			...
			if (empresaAct != null && remitoAct == null && sucursalAct == null && tallerAct == null){
				check = UbicacionController.getInstance().agregarUbicacionCliente(empresaAct.getCodigo(), ubicacion);
				if (check == 3){
					String mensaje = "Se dio de alta la nueva ubicación";
					JOptionPane.showMessageDialog(this, mensaje, "OK", JOptionPane.INFORMATION_MESSAGE);
					UbicacionAltaView.this.dispose();
					...
					if(check == 1){
						...
						if(check == 2){
							String mensaje = "La ubicación ya existe para la empresa";
							JOptionPane.showMessageDialog(this, mensaje, "ERROR", JOptionPane.ERROR_MESSAGE);
						}else{
							String mensaje = "Falla en el alta de la nueva ubicación";
							JOptionPane.showMessageDialog(this, mensaje, "ERROR", JOptionPane.ERROR_MESSAGE);
						}
					}
				}				
				...
				if(remitoAct != null && empresaAct == null  && sucursalAct == null && tallerAct == null){
					...
					if(sucursalAct != null && empresaAct == null  && remitoAct == null && tallerAct == null){
						check = UbicacionController.getInstance().grabarUbicacionSucursal(sucursalAct.getCodigo(), ubicacion);
						if (check == 2){
							String mensaje = "Se dio de alta la nueva ubicación";
							JOptionPane.showMessageDialog(this, mensaje, "OK", JOptionPane.INFORMATION_MESSAGE);
							UbicacionAltaView.this.dispose();
			...
			System.out.println("Mensaje Error al agregar una ubicación: " + e.getMessage());
			System.out.println("Stack Trace al agregar una ubicación: " + e.getStackTrace());
			JOptionPane.showMessageDialog(this, e, "Error", JOptionPane.ERROR_MESSAGE);
		}
	}
	...
	private void btnCancelar (ActionEvent evt){
		try{
			...
			System.out.println("Mensaje Error al cancelar el alta de una ubicación: " + e.getMessage());
			System.out.println("Stack Trace al cancelar el alta de una ubicación: " + e.getStackTrace());
			JOptionPane.showMessageDialog(this, e, "Error", JOptionPane.ERROR_MESSAGE);
		}
	}
}
