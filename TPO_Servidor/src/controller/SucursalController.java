		...
		try {
			...
			if (sucursal!=null){
				...
				if (gerente != null){
					...
					gerenteDTO.setSucursal(gerente.getSucursal());
				}
				...
				if (encargadoDespacho != null){
					...
					encargadoDespachoDTO.setSucursal(encargadoDespacho.getSucursal());
				}
				...
				if (encargadoDeposito != null){
					...
					encargadoDepositoDTO.setSucursal(encargadoDeposito.getSucursal());
				}
				...
				if (encargadoRecepcion != null){
					...
					encargadoRecepcionDTO.setSucursal(encargadoRecepcion.getSucursal());
				}
	...
	public int guardarSucursal(SucursalDTO sucursalDTO) throws RemoteException {
		try {
			...
			if(sucursal == null){
				...
				Empleado encargadoDespacho = (new EmpleadoSRV()).buscarEmpleado(sucursalDTO.getEncargadoDespacho().getNumero());
				sucursal.setEncargadoDespacho(encargadoDespacho);
				Empleado encargadoDeposito = (new EmpleadoSRV()).buscarEmpleado(sucursalDTO.getEncargadoDeposito().getNumero());
				sucursal.setEncargadoDeposito(encargadoDeposito);
				Empleado encargadoRecepcion = (new EmpleadoSRV()).buscarEmpleado(sucursalDTO.getEncargadoRecepcion().getNumero());
				sucursal.setEncargadoRecepcion(encargadoRecepcion);
				
				(new SucursalSRV()).grabarSucursal(sucursal);
				System.out.println("La sucursal se grabó con éxito");
				return 2;
			}else{
				System.out.println("La sucursal ya existe");
				return 1;
	...
	public int ModificarSucursal(SucursalDTO sucursalDTO) throws RemoteException {
		try {
			...
			if(sucursal != null){
				...
				System.out.println("La sucursal se modifico con éxito");
				return 2;
			}else{
	...
	public int eliminarSucursal(SucursalDTO sucursalDTO) throws RemoteException {
		try {
			...
			if(sucursal != null){
				...
				System.out.println("La sucursal se elimino con éxito");
				return 2;
			}else{
				System.out.println("La sucursal no existe");
				return 1;
