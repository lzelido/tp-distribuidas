...
public abstract class VehiculoDTO implements Serializable{
	...
	private PlanMantenimientoDTO planMantenimiento;
	...
	public PlanMantenimientoDTO getPlanMantenimiento() {
		return planMantenimiento;
	}

	public void setPlanMantenimiento(PlanMantenimientoDTO planMantenimiento) {
